        ...
        return (
            <div id='modal-wrapper'>
                <div id='modal'>
                    ...
                    <form method="POST" action='https://harmonyfamilyyoga.com/' name="harmonyfamilyyoga" data-netlify="true">
                      <input className="input" name='email' type="email" placeholder="email"/>
                      <input className="button small" name='submit' type="submit" value="Submit" required/>
                    </form>
